  ...
  <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-icon bg-defalut"><i class="fa fa-users"></i></span>
          ...
          <div class="col-md-8">
            ...
            <div class="box box-info">
              ...
              <div class="box-footer clearfix">                
                <a href="/admin/orders" class="btn btn-sm btn-default btn-flat pull-right">Todos os pedidos</a>
              </div>
              <!-- /.box-footer -->
            </div>
            <!-- /.box -->
          ...
          <div class="col-md-4">
            ...
            <div class="box box-primary">
              ...
              <div class="box-footer text-center">
                <a href="/admin/products">Vê todos os produtos</a>
              </div>
              <!-- /.box-footer -->
            </div>
            <!-- /.box -->
